...
//        String query_test           = "MATCH (n1:P)<-[r0:F]-(n0:P), (n0:P) -[r1:F]-> (n2:P), (n0:P) -[r2:F]-> (n3:P) WHERE (n0.name <> \"Franco\" AND n1.age > 18 AND n3.age >= 25) RETURN n0,n1,n2,n3";
        ...
        String query_test           = "MATCH (n1:P)<-[:F*2..2]-(n0:P), (n0:P) -[:C]-> (n2:P) WHERE (n0.name = \"Leonardo\" AND n0.age = 30 AND n1.name = \"Giuseppe\") RETURN n0,n1,n2,n3";
        ...
        MatchingPathWhere matchingMachine = new MatchingPathWhere(outData, query,true, false, Long.MAX_VALUE, idx_label, target_bitmatrix, graphPaths, macro_nodes, nodes_macro, Optional.of(where_managing));
