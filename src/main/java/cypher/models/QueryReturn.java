...
public class QueryReturn {
    ...
    private void create_prop_alias_array(Expression expression, String item_name){
        ...
        // JSON PART -> {name:n1.name, age: n1.age}
            ...
            while (map_elements.hasNext())
               set_property_data(map_elements.next(), item_name);
        }
    ...
    // GETTER
    public List<String[]> getProperties_map() {return properties_map;}
    public List<String[]> getFunction_map()   {return function_map;  }
    public List<String[]> getOrderby()        {return orderby;       }
    public boolean        isIs_distinct()     {return is_distinct;   }
    public long           getLimit()          {return limit;         }
    public boolean        isCount()           {return is_count;      }
