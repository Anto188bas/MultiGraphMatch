...
public class WhereExpression {
    ...
    public WhereExpression(
       ...
       WhereConditionsData conditionsData
        ...
        left_expression  = WhereConditionHandler.where_condition_handler(lft, nodes, edges, node_name, edge_name, query_nodes, query_edges, conditionsData);
        conj_operator    = cj_op;
        right_expression = WhereConditionHandler.where_condition_handler(rft, nodes, edges, node_name, edge_name, query_nodes, query_edges, conditionsData);
    }
