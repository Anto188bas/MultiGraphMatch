...
public class TypeConditionSelection {
    ...
    public Object inferTypeCondition(Table[] nodes, Table[] edges, Object2IntOpenHashMap<String> node_name, Object2IntOpenHashMap<String> edge_name, NameValue leftElement, Object rightElement) {
    ...
    private Object tableSelection(String property_name, Table[] tables, Object rightElement) {
        // TABLE SELECTION
