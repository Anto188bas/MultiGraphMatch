...
public class PropertiesUtility {
    ...
    public static Object value_type(Expression value) {
        ...
        if (value instanceof SignedDecimalIntegerLiteral || value instanceof IntegerLiteral)
            ...
            // STRING
        else if (value instanceof StringLiteral) return ((StringLiteral) value).value();
        else return null;
    }

    // NO PROPERTY ARRAY SETTING
    public static void add_property(Tuple2<PropertyKeyName, Expression> record, HashMap<String, Object> properties) {
    ...
    public static void add_array_property(Tuple2<PropertyKeyName, Expression> record, HashMap<String, Object> properties) {
    ...
    // PROPERTY SETTING
    public static void configure_properties(Option<Expression> expression, HashMap<String, Object> properties) {
        ...
        while (props_iter.hasNext()) {
            ...
            if (item._2 instanceof ListLiteral) PropertiesUtility.add_array_property(item, properties);
            else PropertiesUtility.add_property(item, properties);
        }
    }
}
