...
public class StateStructures {
    ...
    public StateStructures(int[] map_state_to_edge, int[] map_edge_to_state, int[] map_state_to_src, int[] map_state_to_dst, int[] map_state_to_mnode, EdgeDirection[] map_edge_to_direction) {
