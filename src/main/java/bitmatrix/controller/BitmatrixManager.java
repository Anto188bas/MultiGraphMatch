...
public class BitmatrixManager {
     ...
     */
    public static Int2ObjectOpenHashMap<IntArrayList> bitmatrix_manager(QueryBitmatrix query_bitmatrix, TargetBitmatrix target_bitmatrix) {
        boolean is_directed = query_bitmatrix.isDirected();
