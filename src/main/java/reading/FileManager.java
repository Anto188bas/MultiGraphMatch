...
public class FileManager {
    ...
    public static Table[] files_reading(String elementsFolder, Character sep) {
        ...
        for (File file_name : listFiles) {
            try {
                ...
                Table table = Table.read().usingOptions(CsvReadOptions.builder(file_name).separator(sep).maxCharsPerColumn(100000).columnTypes(table_columns));
    ...
    public static void saveToCSV(String query, String path, double time, long num_occurrences) throws IOException {
