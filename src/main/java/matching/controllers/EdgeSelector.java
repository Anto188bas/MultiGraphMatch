...
public class EdgeSelector {
    ...
    public static void no_types_case(ArrayList<Triplet<Integer, Integer, Integer>> candidates, MatchingData matchingData, IntArrayList[] nodes_symmetry, IntArrayList listCandidates, int q_node, int[] cols, GraphPaths graphPaths) {
    ...
    public static void no_type_case(ArrayList<Triplet<Integer, Integer, Integer>> candidates, int q_node, GraphPaths graphPaths, MatchingData matchingData, IntArrayList[] nodes_symmetry, IntArrayList listCandidates) {
    ...
    public static void types_case(ArrayList<Triplet<Integer, Integer, Integer>> candidates, MatchingData matchingData, IntArrayList[] nodes_symmetry, IntArrayList listCandidates, int q_node, int[] cols, GraphPaths graphPaths, QueryEdge query_edge) {
        for (int i = 0; i < cols.length; i++) {
            int column = cols[i];
            candidates.forEach(triplet -> {
                int t_node = (column == 0 ? triplet.getValue0() : triplet.getValue1());
    ...
    public static void types_case(ArrayList<Triplet<Integer, Integer, Integer>> candidates, int query_node, GraphPaths graphPaths, MatchingData matchingData, IntArrayList[] nodes_symmetry, IntArrayList listCandidates, QueryEdge query_edge, int t_src, int t_dst) {
    ...
    public static void no_types_case_matched_nodes(ArrayList<Triplet<Integer, Integer, Integer>> candidates, MatchingData matchingData, IntArrayList[] edges_symmetry, IntArrayList listCandidates, GraphPaths graphPaths, StateStructures states, int q_edge) {
        candidates.forEach(triplet -> {
            IntArrayList[] colors_edges = graphPaths.getMap_key_to_edge_list()[triplet.getValue2()];
            for (IntArrayList edges : colors_edges) {
                if (edges == null) continue;
    ...
    public static void type_case_matched_nodes(ArrayList<Triplet<Integer, Integer, Integer>> candidates, MatchingData matchingData, IntArrayList[] edges_symmetry, IntArrayList listCandidates, GraphPaths graphPaths, StateStructures states, int q_edge, QueryEdge query_edge) {
        candidates.forEach(triplet -> {
            IntArrayList[] colors_edges = graphPaths.getMap_key_to_edge_list()[triplet.getValue2()];
            for (int color : query_edge.getEdge_label()) {
                IntArrayList edges = colors_edges[color];
